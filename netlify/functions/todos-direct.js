...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    // Handle Todo item operations
      ...
      if ((pathParts[3] === 'todos' || pathParts[3] === 'todo') && event.httpMethod === 'POST') {
      ...
      else if ((pathParts[3] === 'todos' || pathParts[3] === 'todo') && pathParts.length >= 5 && event.httpMethod === 'PUT') {
      ...
      else if ((pathParts[3] === 'todos' || pathParts[3] === 'todo') && pathParts.length >= 5 && event.httpMethod === 'DELETE') {
        const todoId = pathParts[4];
